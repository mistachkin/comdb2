...
#ifdef SQLITE_ENABLE_STAT4
#if defined(SQLITE_BUILDING_FOR_COMDB2)
static void sampleSetPackedRow(sqlite3 *db, StatSample *p, int n, const u8 *pData){
  assert( db!=0 );
...
#define STAT_GET_NEQ   1          /* "neq" column of stat[4] entry */
#define STAT_GET_NLT   2          /* "nlt" column of stat[4] entry */
#define STAT_GET_NDLT  3          /* "ndlt" column of stat[4] entry */

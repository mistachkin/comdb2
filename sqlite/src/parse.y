...
%ifdef SQLITE_BUILDING_FOR_COMDB2
  ...
  DATA DATABLOB DATACOPY DBPAD DDL DEFERRABLE DISABLE DISTRIBUTION DRYRUN
...
%ifdef SQLITE_BUILDING_FOR_COMDB2
                            {comdb2AddDefaultValue(pParse,X,A.z,&A.z[A.n]);}
%endif SQLITE_BUILDING_FOR_COMDB2
%ifndef SQLITE_BUILDING_FOR_COMDB2
...
%ifdef SQLITE_BUILDING_FOR_COMDB2
                            {comdb2AddDefaultValue(pParse,X,A.z,&Z.z[Z.n]);}
%endif SQLITE_BUILDING_FOR_COMDB2
%ifndef SQLITE_BUILDING_FOR_COMDB2
...
#if defined(SQLITE_BUILDING_FOR_COMDB2)
  comdb2AddDefaultValue(pParse,p,A.z,&Z.z[Z.n]);
#else /* defined(SQLITE_BUILDING_FOR_COMDB2) */
...
%endif !SQLITE_BUILDING_FOR_COMDB2
%ifdef SQLITE_BUILDING_FOR_COMDB2
cmd ::= with UPDATE xfullname(X) indexed_opt(I) SET setlist(Y) from(F)
%endif SQLITE_BUILDING_FOR_COMDB2
